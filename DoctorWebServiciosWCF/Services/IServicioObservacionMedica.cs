...
namespace DoctorWebServiciosWCF.Services
{
    ...
    { 
        ...
        [OperationContract]
        [WebGet(UriTemplate = "/ObtenerListaObservacionMedica", ResponseFormat = WebMessageFormat.Json, BodyStyle = WebMessageBodyStyle.Wrapped)]
        ResultadoServicio<List<ObservacionMedica>> ObtenerListaObservacionMedica();
