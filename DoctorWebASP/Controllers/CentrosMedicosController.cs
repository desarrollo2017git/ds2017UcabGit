...
namespace DoctorWebASP.Controllers
{
    public class CentrosMedicosController : Controller
    {
        ...
        // GET: CentrosMedicos/Create
        public ActionResult Create()
        {
            return View();
        }

        // POST: CentrosMedicos/Create
